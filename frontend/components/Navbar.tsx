	...
	return (
		<header className="border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur-xl sticky top-0 z-40 mb-8">
			<div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
				...
				>
					<div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-red-700 to-red-500 flex items-center justify-center text-xl shadow-lg shadow-red-950/60 font-black group-hover:scale-105 transition-transform">
						🏎️
					</div>
					<div>
				...
				<div className="flex items-center gap-3 text-xs font-mono">
					{onResetSearch && (
						<button
							onClick={onResetSearch}
							className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white px-3 py-1.5 rounded-xl border border-zinc-700 font-semibold transition flex items-center gap-1.5"
						>
							🔍 Search Races
						</button>
					)}
